package aufgabenKontovergleich;
...
public class KontoTest {
	...
	public static void kontoVergleich(Konto k1, Konto k2) {
		if (k1.getKontostand() > k2.getKontostand()) {
			System.out
					.println(k1.getPerson().getName() + " hat mehr Geld auf dem Konto als " + k2.getPerson().getName());
		} else {
			System.out
					.println(k2.getPerson().getName() + " hat mehr Geld auf dem Konto als " + k1.getPerson().getName());
		}
	}
